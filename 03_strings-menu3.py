class StringHandler:
    ...
    def custom_slice_and_print_language(self):
        start = int(input("Introduzca el índice de inicio: "))
        end = int(input("Introduzca el índice final: "))
        step = int(input("Introduzca el paso: "))

        language_slice = self.language[start:end:step]
...
def main_menu(handler):
    ...
    options = [
        ...
        "Introducir índices personalizados para dividir e imprimir language",
        "Salir"
    ]
    ...
    if choice == 1:
        ...
        handler.custom_slice_and_print_language()
    elif choice == 6:
